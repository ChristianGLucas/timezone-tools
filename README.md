...
https://dev.axiomide.com/marketplace/christiangeorgelucas/timezone-tools@0.1.2
...
```bash
axiom invoke christiangeorgelucas/timezone-tools/ConvertZone --input '{ ... }'
```

**Call it over HTTP.**

```bash
curl -X POST https://api.axiomide.com/invocations/v1/nodes/christiangeorgelucas/timezone-tools/0.1.2/ConvertZone \
...
> `axiom inspect node christiangeorgelucas/timezone-tools/ConvertZone`.
